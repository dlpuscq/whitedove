...
import com.whitedove.pojo.TbItemParamItemExample;
...
public class ItemParamItemServiceImpl implements ItemParamItemService {
	...
	public String getItemParamByItemId(Long itemId) {
		...
		sb.append("<table cellpadding=\"0\" cellspacing=\"1\" width=\"70%\" border=\"1\" class=\"Ptable\">\n");
		sb.append("    <tbody>\n");
		for(Map m1:jsonList) {
			sb.append("        <tr>\n");
			sb.append("            <th class=\"tdTitle\" colspan=\"1\">"+m1.get("group")+"</th>\n");
			sb.append("        </tr>\n");
	...
	@Override
	public WhiteDoveResult getItemParamItem(Long itemId) {
		TbItemParamItemExample example = new TbItemParamItemExample();
		TbItemParamItemExample.Criteria criteria = example.createCriteria();
		criteria.andItemIdEqualTo(itemId);
		List<TbItemParamItem> list = itemParamItemMapper.selectByExampleWithBLOBs(example);
