<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<form id="jobForm"  style="width:400px;height:400px;">
<table cellpadding="5" style="margin-left: 30px" id="itemParamAddTable"
	class="itemParam">
	<tr>
		<td>学科类型:</td>
		<td><a href="javascript:void(0)"
			class="easyui-linkbutton selectItemCat">选择类型</a> <input type="hidden"
	...
	$(function(){
		...
		$("#itemParamAddTable .submit").click(function(){
			...
			$.post(url,{"paramData":JSON.stringify(params)},function(data){
				if(data.status == 200){
					$.messager.alert('提示','新增学科规格成功!',undefined,function(){
						$(".panel-tool-close").click();
