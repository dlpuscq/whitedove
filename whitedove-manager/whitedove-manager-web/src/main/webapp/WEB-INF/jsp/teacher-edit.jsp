...
<div style="padding:10px 10px 10px 10px">
    <form id="contentEditForm" class="itemForm" method="post">
        ...
        <table cellpadding="5">
            ...
            <tr>
                <td>教学科目:</td>
                <td><input class="easyui-textbox" type="text" readonly="true" name="catName" style="width: 280px;"></input></td>
            </tr>
            <tr>
                <td>图片:</td>
                <td>
...
<script type="text/javascript">
    ...
    var contentEditPage = {
        submitForm : function(){
            ...
            $.post("/teachers/edit",$("#contentEditForm").serialize(), function(data){
                if(data.status == 200){
