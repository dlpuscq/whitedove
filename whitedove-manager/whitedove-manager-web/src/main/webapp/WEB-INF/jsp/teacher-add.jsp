...
<div style="padding:10px 10px 10px 10px">
    <form id="contentAddForm" class="itemForm" method="post">
        ...
        <table cellpadding="5">
            <tr>
                <td>教师名称:</td>
                <td><input class="easyui-textbox" type="text" name="teacherName" data-options="required:true" style="width: 280px;"></input></td>
            </tr>
            <tr>
                <td>教师介绍:</td>
            ...
            <tr>
                <td>教学科目:</td>
                <td><input class="easyui-textbox" readonly="true" type="text" name="catName" style="width: 280px;"/></td>
                <input type="hidden" name="catId"/>
            </tr>
            <tr>
                <td>图片:</td>
...
<script type="text/javascript">
    ...
    $(function(){
        TT.initOnePicUpload();
        $("#contentAddForm [name=catId]").val($("#contentCategoryTree").tree("getSelected").id);
        $("#contentAddForm [name=catName]").val($("#contentCategoryTree").tree("getSelected").text);
    });
    ...
    var contentAddPage  = {
        submitForm : function (){
            ...
            $.post("/teachers/save",$("#contentAddForm").serialize(), function(data){
                if(data.status == 200){
